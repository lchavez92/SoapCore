...
namespace SoapCore
{
        ...
        where T_MESSAGE : CustomMessage, new()
    {
        ...
        private async Task ProcessMeta(HttpContext httpContext)
        {
            ...
            var bodyWriter = _serializer == SoapSerializer.XmlSerializer ? new MetaBodyWriter(_service, baseUrl, _binding, _xmlNamespaceManager, _options.SkipImportNamespaces) : (BodyWriter)new MetaWCFBodyWriter(_service, baseUrl, _binding);
